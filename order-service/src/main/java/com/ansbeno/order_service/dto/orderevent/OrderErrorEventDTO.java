...
@NoArgsConstructor
@Builder
public class OrderErrorEventDTO extends OrderEventDTO {
      private Customer customer;
      private Address deliveryAddress;
      private String reason;

      public OrderErrorEventDTO(String eventId, String orderNumber, Set<OrderItemDTO> items, Customer customer,
                  Address deliveryAddress, String reason, LocalDateTime createdAt) {
            super(eventId, OrderEventType.ORDER_PROCESSING_FAILED, items, orderNumber, createdAt, null);
            this.items = items;
